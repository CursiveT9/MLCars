...
model_data = joblib.load('full_model.pkl')
...
# Toyota,RAV4,Джип 5 дв.,Белый,Бензин,2010.0,170000.0,Вариатор,158.0,1279000,3ZR-FAE,2.0,Салехард
# Kia,Cerato,Седан,Белый,Бензин,2019.0,91000.0,АКПП,150.0,1980000,G4NA,2.0,Муравленко
# Лада,2110,Седан,Серебристый,Бензин,2001.0,250000.0,Механика,89.0,80000,ВАЗ-21124,1.6,Новый Уренгой

# Новые данные
new_data = ['Toyota', 'RAV4', 'Джип 5 дв.', 'Белый', 'Бензин', 2010.0, 170000.0, 'Вариатор', 158.0, '3ZR-FAE', 2.0, 'Салехард']
# new_data = ['Kia', 'Cerato', 'Седан', 'Белый', 'Бензин', 2019.0, 91000.0, 'АКПП', 150.0, 'G4NA', 2.0, 'Муравленко']
# new_data = ['Лада', '2110', 'Седан', 'Серебристый', 'Бензин', 2001.0, 250000.0, 'Механика', 89.0, 'ВАЗ-21124', 1.6, 'Новый Уренгой']
...
categorical_columns_indices = [0, 1, 2, 3, 4, 7, 9, 11]
