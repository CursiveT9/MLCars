...
output_file_path = '../data/all_regions_last_1000.csv'
...
# Сохранение последних n строк в новый файл
df_cleaned.tail(1000).to_csv(output_file_path, index=False)

print(f"Файл с последними 100 строками без пустых полей сохранен как {output_file_path}.")
