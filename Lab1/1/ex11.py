...
from plotData1 import plotData
...
X = np.c_[np.ones(x.shape[0]), x]  # X становится двумерным массивом
...
plt.plot(x, theta[0] + theta[1] * x, label='Апроксимирующая прямая', color='blue')
